...
tolerance_list <- exp(seq(log(0.01), log(0.000001), length.out = 8))
graph_structure_vec <- c("hub_1", "hub_09", "AR2", "random")
#solver_vec <- c("pcglassoFast_Primal", "pcglassoFast_Dual", "pcglassoFast_PrimalDual", "pcglasso", "path_up", "path_down")
solver_vec <- c("pcglassoFast_Primal", "pcglassoFast_Dual", "pcglassoFast_PrimalDual", "pcglasso")
#solver_vec <- c("pcglassoFast_Primal", "pcglassoFast_Dual", "pcglasso", "path_up", "path_down")
